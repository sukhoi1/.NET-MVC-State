...
namespace MvcState.Controllers
{
    public class CalcController : Controller
    {
        public ActionResult Index()
        {
            ...
            data.Add("Counter", AppStateHelper.Get(AppStateKeys.Counter).ToString());
        ...
        public ActionResult Increment()
        {
            ...
            int value = (int)AppStateHelper.Get(AppStateKeys.Counter);
            AppStateHelper.Set(AppStateKeys.Counter, ++value);
